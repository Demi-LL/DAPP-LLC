<template>
  <div class="container">
    ...
    <div class="row mb-5">
      <button @click="reloadOwnersAndBalances()" class="col-2 container btn btn-danger" type="button">刷新</button>
    </div>
...
export default {
  ...
  created() {
    this.reloadOwnersAndBalances();
  },
  methods: {
    reloadOwnersAndBalances() {
      this.contract.then(ins => {
        ins.ownersList()
          .then(addresses => this.accounts = addresses)
